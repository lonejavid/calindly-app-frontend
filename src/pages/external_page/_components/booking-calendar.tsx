...
const BookingCalendar = ({
  ...
  const [currentlySelectedDisplayTime, setCurrentlySelectedDisplayTime] = useState<string | null>(null);
  ...
  const handleSlotSelection = (slotData: any) => {
    try {
      ...
      // Store the display time for UI comparison
      setCurrentlySelectedDisplayTime(displayTime);
      
      // Store the proper datetime for backend/next component
      handleSelectSlot(displayTime);
  ...
  // Use the display time for UI comparison, but keep selectedSlot for backend
  const selectedTime = currentlySelectedDisplayTime;
