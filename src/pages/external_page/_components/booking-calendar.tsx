...
const BookingCalendar = ({
  ...
  // Filter time slots to only show those that fall on the selected date (12:00 AM to 11:59 PM)
  const filteredTimeSlots = useMemo(() => {
    ...
    return timeSlots.filter(slotData => {
      ...
      if (slotData.dateTime) {
        return slotData.dateTime >= startOfDay && slotData.dateTime <= endOfDay;
      }
      
      // Fallback: try to parse the converted time
      try {
