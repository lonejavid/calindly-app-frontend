  ...
  const eventSchema = z.object({
    ...
    locationType: z
      ...
      .refine((value) => value !== undefined, {
        ...
        accessSpecifier: z.enum(["allow_all", "disable_public"], {
    required_error: "Access specifier is required",
  }),
  });
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl className="mt-2">
                          <select
                            {...field}
                            className="w-full px-3 py-2 border rounded-md bg-white text-sm border-[#B2B2B2]"
                          >
                            <option value="allow_all">Allow all to book time</option>
                            <option value="disable_public">Disable public domains to book time</option>
                          </select>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
