...
//             <h2 className="text-5xl sm:text-7xl lg:text-8xl font-black mb-6 sm:mb-8 leading-tight tracking-tight">
      ...
      <section className="relative z-10 pt-8 sm:pt-16 pb-16 sm:pb-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className={`text-center transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-black mb-8 sm:mb-12 leading-tight tracking-tight">
              <span className="bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent block mb-2">
                The World's First
              </span>
              <span className="bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 bg-clip-text text-transparent block mb-2">
                Intelligent Scheduling
              </span>
              <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent block mb-2">
                & Client Acquisition
              </span>
              <span className="bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent block">
                Platform
            ...
            <div className="max-w-6xl mx-auto mb-8 sm:mb-12">
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-6 leading-relaxed font-medium">
                We don't just manage your schedule - <strong className="text-white">we help you book high-value meetings.</strong>
              </p>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 mb-10 max-w-4xl mx-auto leading-relaxed">
              Get your <strong className="text-white">first high-ticket client booked in 7 days</strong> or pay nothing. 
              Our unique combination of AI technology and human expertise eliminates spam while delivering 
              <strong className="text-emerald-300"> revenue-ready prospects</strong> directly to your calendar.
            </p>
