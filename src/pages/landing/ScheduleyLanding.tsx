...
import { useState, useEffect } from 'react';
import { Calendar, Shield, Linkedin, Clock, CheckCircle, ArrowRight, Zap, Filter, Users, Menu, X, Star, Award, TrendingUp, Globe, Sparkles, Rocket, Target, BarChart, Lock, MessageCircle, Smartphone, Phone, Mail, Play } from 'lucide-react';
import { useNavigate } from "react-router-dom";
import { AUTH_ROUTES } from "@/routes/common/routePaths";
...
const ScheduleyLanding = () => {
  ...
  const [activeFeature, setActiveFeature] = useState(0);
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
  const [animatedStats, setAnimatedStats] = useState({ meetings: 0, revenue: 0, clients: 0 });
  const [currentTestimonial, setCurrentTestimonial] = useState(0);
  ...
  useEffect(() => {
    ...
    const statsInterval = setInterval(() => {
      setAnimatedStats(prev => ({
        ...
        revenue: Math.min(prev.revenue + 1.2, 47),
        clients: Math.min(prev.clients + 8, 500)
      }));
    }, 50);
  ...
  // Professional features with business focus
  const features = [
    {
      icon: <Target className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: "Targeted Prospect Discovery",
      description: "AI-powered research identifies your ideal clients from our database of 10,000+ verified B2B contacts across industries",
      highlight: "10K+ Contacts"
    },
    {
      icon: <MessageCircle className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: "Multi-Channel Outreach",
      description: "Automated sequences across email, LinkedIn, and phone with personalized messaging that converts 67% better",
      highlight: "67% Higher Response"
    },
    {
      icon: <Calendar className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: "Smart Calendar Integration", 
      description: "Qualified prospects book directly into your calendar with full context and meeting preparation included",
      highlight: "Seamless Booking"
    },
    {
      icon: <BarChart className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: "Performance Analytics",
      description: "Track response rates, meeting quality, and ROI with detailed insights to optimize your sales pipeline",
      highlight: "Data-Driven"
    },
    {
      icon: <Shield className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: "Compliance Management",
      description: "GDPR, CAN-SPAM, and LinkedIn ToS compliant outreach ensures your campaigns stay within platform guidelines",
      highlight: "100% Compliant"
    },
    {
      icon: <Users className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: "White-Glove Service",
      description: "Dedicated account manager handles campaign setup, optimization, and ongoing management for you",
  ...
  const benefits = [
    { text: "Get your first qualified meeting within 7 days", icon: <CheckCircle className="w-4 h-4" /> },
    { text: "100% money-back guarantee if no meetings booked", icon: <Shield className="w-4 h-4" /> },
    { text: "Average deal size of $47,000 per closed opportunity", icon: <Target className="w-4 h-4" /> },
    { text: "67% higher response rates than industry average", icon: <TrendingUp className="w-4 h-4" /> },
    { text: "Full compliance with all platform terms of service", icon: <Lock className="w-4 h-4" /> },
    { text: "Dedicated account manager included with every plan", icon: <Users className="w-4 h-4" /> },
    { text: "Complete campaign setup and optimization handled", icon: <Rocket className="w-4 h-4" /> },
    { text: "Trusted by 500+ B2B companies worldwide", icon: <Globe className="w-4 h-4" /> }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "127 qualified meetings booked in 90 days. Schedley transformed our entire sales process and tripled our revenue.",
      rating: 5
    },
    {
      name: "Michael Rodriguez", 
      ...
      content: "The ROI is incredible. We're closing 10x more deals with higher-quality prospects than ever before.",
      rating: 5
    },
    {
      name: "Emily Johnson",
      ...
      content: "Best investment we've made. The white-glove service means we can focus entirely on closing deals.",
      rating: 5
    }
  ];
  ...
  const workflowSteps = [
    {
      ...
      description: "We analyze your ideal client profile and build targeted prospect lists",
      metric: "10,000+ verified B2B contacts"
    },
    {
      number: "2",
      title: "Smart Outreach Automation", 
      description: "Our AI-powered sequences engage prospects across email, LinkedIn, and phone",
      metric: "67% higher response rates"
    },
    {
      number: "3",
      title: "Seamless Booking & Handoff",
      description: "Qualified prospects book directly into your calendar with all context provided", 
      metric: "Average deal size: $47,000"
    }
  ];
  ...
  const brandLogos = [
    ...
    { name: "Monday", color: "text-red-400" }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 text-gray-900">
      {/* Clean Professional Navigation */}
      <nav className={`relative z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg overflow-hidden flex items-center justify-center bg-white shadow-sm border border-gray-200">
                <img
                  src={mylogo}
                  alt="Schedley"
                  className="w-full h-full object-contain"
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <a href="#case-studies" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">Case Studies</a>
              <a href="#pricing" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">Pricing</a>
              <a href="#growth-hub" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">Growth Hub</a>
              <button className="text-gray-600 hover:text-gray-900 transition-colors duration-200">Book Demo</button>
              <button 
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-100 py-4">
              <div className="flex flex-col space-y-4">
                <a href="#how-it-works" className="text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileMenuOpen(false)}>How It Works</a>
                <a href="#case-studies" className="text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileMenuOpen(false)}>Case Studies</a>
                <a href="#pricing" className="text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileMenuOpen(false)}>Pricing</a>
                <button 
                  onClick={() => {
                    navigate('/carrer');
                    setMobileMenuOpen(false);
                ...
                <button 
                  ...
                  className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium text-center mt-4"
                >
                  Get Started
                </button>
              </div>
      ...
      <section className="relative pt-12 sm:pt-20 pb-16 sm:pb-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className={`text-center transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold mb-6 sm:mb-8 leading-tight text-gray-900">
              Get Your First <br />
              <span className="text-blue-600">High-Ticket Client</span> <br />
              Booked in 7 Days
            </h1>
            
            <div className="text-xl sm:text-2xl font-semibold mb-8 text-red-600">
              Or Pay Nothing. Guaranteed.
            </div>
            
            <p className="text-lg sm:text-xl text-gray-600 mb-10 max-w-4xl mx-auto leading-relaxed">
              We combine advanced outreach automation with calendar management to book qualified prospects 
              directly into your sales pipeline. <span className="font-semibold text-gray-900">No bookings in week 1 = 100% refund.</span>
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <button 
                onClick={() => navigate(AUTH_ROUTES.SIGN_IN)}
                className="bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition-colors duration-200 flex items-center w-full sm:w-auto justify-center shadow-lg"
              >
                <Calendar className="mr-3 w-5 h-5" />
                Book My Strategy Call
              </button>
              <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg text-lg font-semibold hover:border-gray-400 hover:bg-gray-50 transition-colors duration-200 flex items-center w-full sm:w-auto justify-center">
            ...
            <div className="flex flex-col items-center space-y-3 mb-12">
              ...
              <div className="text-sm text-gray-500">
                Trusted by <span className="font-semibold text-gray-900">{animatedStats.clients}+ B2B Companies</span>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {workflowSteps.map((step, index) => (
              <div key={index} className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center justify-between mb-6">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl font-bold mb-6 text-gray-900">
              Why Smart B2B Companies Choose Schedley
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Guarantee-Backed Results</h3>
              <p className="text-gray-600">First qualified booking in 7 days or 100% refund</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Growth Hacking Methodology</h3>
              <p className="text-gray-600">We don't just schedule - we strategically grow your pipeline using proven B2B tactics</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Data-Driven Optimization</h3>
              <p className="text-gray-600">Every campaign is A/B tested and optimized for your industry</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">White-Glove Service</h3>
              <p className="text-gray-600">Dedicated account manager handles everything while you focus on sales calls</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Compliance First</h3>
              <p className="text-gray-600">GDPR, CAN-SPAM, and LinkedIn ToS compliant outreach</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">Trusted by 500+ B2B companies with $47K average deal size</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <div className="text-gray-600 font-semibold">Qualified Meetings</div>
              ...
              <div className="text-center">
                ...
                <div className="text-gray-600 font-semibold">Average Deal Size</div>
                <div className="text-sm text-gray-500 mt-1">Per closed deal</div>
              </div>
              <div className="text-center">
                <div className="text-4xl sm:text-5xl font-bold text-purple-600 mb-2">
                  {animatedStats.clients}+
                </div>
                <div className="text-gray-600 font-semibold">B2B Companies</div>
                <div className="text-sm text-gray-500 mt-1">Trust Schedley</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Testimonials Section */}
      <section id="case-studies" className="py-16 sm:py-24 bg-gray-50 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl p-8 sm:p-12 shadow-sm border border-gray-100">
            <div className="text-center">
              ...
              <blockquote className="text-xl sm:text-2xl text-gray-600 mb-8 italic leading-relaxed">
                "{testimonials[currentTestimonial].content}"
              </blockquote>
      ...
      <section id="pricing" className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-blue-600 text-white rounded-xl p-8 sm:p-12">
            <div className="inline-flex items-center px-4 py-2 bg-white/20 rounded-full mb-6">
              <Target className="w-4 h-4 mr-2" />
              <span className="font-semibold text-sm">7-Day Performance Guarantee</span>
            </div>
            ...
            <p className="text-lg sm:text-xl mb-8 opacity-90 max-w-3xl mx-auto">
              Join 500+ B2B companies that transformed their sales process with our guarantee-backed outreach automation.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button 
                onClick={() => navigate(AUTH_ROUTES.SIGN_IN)}
                className="bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors duration-200 flex items-center w-full sm:w-auto justify-center shadow-lg"
              >
                <Calendar className="mr-3 w-5 h-5" />
              ...
              <div className="text-center text-white/80">
                <div className="text-sm mb-1">✅ First Meeting in 7 Days</div>
                <div className="text-sm">🎯 Or 100% Money Back</div>
              </div>
            </div>
      ...
      <footer className="py-12 px-4 sm:px-6 border-t border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-4 max-w-md">
                The world's most intelligent B2B outreach automation platform. We guarantee qualified meetings in 7 days or your money back.
              </p>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="#case-studies" className="block text-gray-600 hover:text-gray-900 transition-colors duration-200">Case Studies</a>
                <a href="#pricing" className="block text-gray-600 hover:text-gray-900 transition-colors duration-200">Pricing</a>
                <a href="#growth-hub" className="block text-gray-600 hover:text-gray-900 transition-colors duration-200">Growth Hub</a>
                <button onClick={() => navigate('/carrer')} className="block text-gray-600 hover:text-gray-900 transition-colors duration-200 text-left">Careers</button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <button onClick={() => navigate('/privacy')} className="block text-gray-600 hover:text-gray-900 transition-colors duration-200 text-left">Privacy Policy</button>
                <button onClick={() => navigate('/terms')} className="block text-gray-600 hover:text-gray-900 transition-colors duration-200 text-left">Terms of Service</button>
                <a href="#compliance" className="block text-gray-600 hover:text-gray-900 transition-colors duration-200">Compliance</a>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-200 space-y-4 sm:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-8 text-gray-500 text-sm">
              <span>© 2024 Schedley.com - All rights reserved</span>
              <span className="hidden sm:block">•</span>
              <a href="mailto:hello@schedley.com" className="hover:text-gray-900 transition-colors duration-200">
                hello@schedley.com
              </a>
            </div>
