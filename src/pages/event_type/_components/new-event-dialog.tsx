...
const EventCreationSidePanel = ({ isOpen, onClose }: EventCreationSidePanelProps) => {
  ...
  const resetForm = (): void => {
    ...
    setBufferBefore(0);
    setBufferAfter(0);
    setMaxBookingsPerDay(null);
    setAllowGuests(true);
    setTimeZoneDisplay('auto-detect');
    setTimeSlotInterval('30');
    setEmailConfirmation(true);
    setEmailReminder(true);
    setCalendarInvitation(true);
    setRedirectToUrl(false);
    setRedirectUrl('');
    setConfirmationMessage('Thank you for booking! We look forward to meeting with you.');
    setBlockedDomains([]);
    setCustomDomain('');
    setQuestions([
      {
