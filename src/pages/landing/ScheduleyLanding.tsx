...
const ScheduleyLanding = () => {
  ...
  const benefits = [
    {
      ...
      description: "First qualified booking in 7 days or 100% refund"
    },
    {
      icon: <Rocket className="w-6 h-6" />,
      title: "Growth Hacking Methodology", 
      description: "We don't just schedule - we strategically grow your pipeline using proven B2B tactics"
    },
    {
      icon: <BarChart className="w-6 h-6" />,
      title: "Data-Driven Optimization",
      description: "Every campaign is A/B tested and optimized for your industry"
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "White-Glove Service",
      description: "Dedicated account manager handles everything while you focus on sales calls"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Compliance First",
      description: "GDPR, CAN-SPAM, and LinkedIn ToS compliant outreach"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3 sm:space-x-4">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl overflow-hidden flex items-center justify-center bg-white shadow-2xl transform hover:scale-105 transition-transform duration-300">
              <img
                src={mylogo}
                alt="Schedley - B2B Lead Generation Platform"
                className="w-full h-full object-contain"
              />
            </div>
            <span className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <a href="#case-studies" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-105">Case Studies</a>
            <a href="#pricing" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-105">Pricing</a>
            <a href="#growth-hub" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-105">Growth Hub</a>
            <button className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-105">Book Demo</button>
          </div>
          ...
          <div className="hidden md:flex lg:hidden items-center space-x-6">
            ...
            <button className="bg-gradient-to-r from-purple-600 via-purple-500 to-pink-500 px-6 py-2 rounded-full hover:from-purple-700 hover:to-pink-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl font-semibold" onClick={() => navigate(AUTH_ROUTES.SIGN_IN)}>
              Get Started
            </button>
            <a 
              href="https://www.linkedin.com/company/schedley-com" 
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-slate-900/98 backdrop-blur-xl border-t border-white/10 p-6 shadow-2xl">
            <div className="flex flex-col space-y-6">
              ...
              <a href="#case-studies" className="text-gray-300 hover:text-white transition-colors duration-300 py-2" onClick={() => setMobileMenuOpen(false)}>Case Studies</a>
      ...
      <section className="relative z-10 pt-8 sm:pt-16 pb-16 sm:pb-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className={`text-center transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="text-3xl sm:text-4xl font-bold mb-8 bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">
            ...
            <p className="text-xl sm:text-2xl text-gray-300 mb-10 max-w-4xl mx-auto leading-relaxed">
              ...
              directly into your sales pipeline. <strong className="text-white">No bookings in week 1 = 100% refund.</strong>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
              ...
              <button className="px-10 py-5 rounded-full text-xl font-bold border-2 border-white/40 hover:border-white/60 backdrop-blur-xl transition-all duration-300 hover:bg-white/10 w-full sm:w-auto transform hover:scale-105 flex items-center justify-center">
            ...
            <div className="flex flex-col items-center space-y-4 mb-8">
              ...
              <div className="text-sm text-gray-400">
                Trusted by <span className="text-white font-bold">{animatedStats.clients}+ B2B Companies</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 mt-12">
              {brandLogos.map((brand, index) => (
                <div key={index} className={`text-lg font-bold ${brand.color} opacity-70 hover:opacity-100 transition-opacity duration-300`}>
                  {brand.name}
                </div>
              ))}
            </div>
            ...
            {workflowSteps.map((step, index) => (
              <div key={index} className="relative">
                ...
                {index < workflowSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 opacity-30 z-0" style={{transform: 'translateX(-50%)'}}></div>
                )}
                
                <div className="bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 relative z-10">
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-2xl font-black shadow-2xl">
                      {step.number}
                    </div>
                    <div className="text-xs font-bold text-emerald-400 bg-emerald-500/20 px-3 py-1 rounded-full">
                      {step.metric}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.slice(0, 3).map((benefit, index) => (
              <div key={index} className="bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:border-purple-500/50 transition-all duration-500 hover:scale-105">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-4xl mx-auto">
            {benefits.slice(3).map((benefit, index) => (
              <div key={index + 3} className="bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:border-purple-500/50 transition-all duration-500 hover:scale-105">
                <div className="text-purple-400 mb-6">
                  {benefit.icon}
                </div>
                <h3 className="text-xl font-bold mb-4 text-white">
      ...
      {/* Testimonials Section */}
      <section id="case-studies" className="py-16 sm:py-24 px-4 sm:px-6 relative">
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/20">
            <div className="text-center">
              <div className="flex justify-center mb-4">
              ...
              <div className="mb-6">
                ...
                <div className="text-purple-300">{testimonials[currentTestimonial].role}</div>
                <div className="text-gray-400 text-sm">{testimonials[currentTestimonial].company}</div>
                <div className="text-emerald-400 font-semibold text-sm mt-2">{testimonials[currentTestimonial].results}</div>
              </div>
          ...
          <div className="bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-2xl rounded-3xl p-10 sm:p-16 border border-white/30 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full mb-8 border border-green-500/30">
                ...
                <span className="font-bold text-green-300">7-Day Performance Guarantee</span>
              </div>
              ...
              <p className="text-xl sm:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
                Join <strong className="text-white">500+ B2B companies</strong> that transformed their sales process 
                with our <strong className="text-purple-300">guarantee-backed outreach automation</strong>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                ...
                <div className="text-center">
                  <div className="text-sm text-gray-400 mb-2">✅ First Meeting in 7 Days</div>
                  <div className="text-sm text-gray-400">🎯 Or 100% Money Back</div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 leading-relaxed mb-6 max-w-md">
                The world's most intelligent B2B outreach automation platform. We combine advanced AI, 
                compliance-first methodology, and white-glove service to guarantee qualified meetings in 7 days.
              </p>
              <div className="flex space-x-4">
                <a 
                  href="https://www.linkedin.com/company/schedley-com" 
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="#case-studies" className="block text-gray-400 hover:text-white transition-colors duration-300">Case Studies</a>
                <a href="#pricing" className="block text-gray-400 hover:text-white transition-colors duration-300">Pricing</a>
                <a href="#growth-hub" className="block text-gray-400 hover:text-white transition-colors duration-300">Growth Hub</a>
                <button onClick={() => navigate('/carrer')} className="block text-gray-400 hover:text-white transition-colors duration-300 text-left">Careers</button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <button onClick={() => navigate('/privacy')} className="block text-gray-400 hover:text-white transition-colors duration-300 text-left">Privacy Policy</button>
                <button onClick={() => navigate('/terms')} className="block text-gray-400 hover:text-white transition-colors duration-300 text-left">Terms of Service</button>
                <a href="#compliance" className="block text-gray-400 hover:text-white transition-colors duration-300">Compliance</a>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/10 text-xs text-gray-500 leading-relaxed">
            <p>
              <strong>Schedley</strong> - B2B Lead Generation & Outreach Automation | Guaranteed Meetings in 7 Days | 
              AI-Powered Prospecting | LinkedIn Automation | Email Outreach | Sales Pipeline Management | 
              Cold Outreach Compliance | GDPR & CAN-SPAM Compliant | White-Glove Service | 
              B2B Sales Automation | Lead Generation Platform | Qualified Meeting Booking | 
              High-Ticket Client Acquisition | Enterprise Security | Money-Back Guarantee
            </p>
          </div>
        </div>
      </footer>
