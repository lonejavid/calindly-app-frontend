...
//   days,
//   timeGap,
//   userTimezone: existingUserTimezone, // Receive existing timezone from props
// }: {
...
//     // Send the original times WITHOUT converting to UTC
//     // The backend will store the times as-is along with the timezone
//     const dataToSend = {
...
import { updateUserAvailabilityMutationFn } from "@/lib/api";
import { Loader } from "@/components/loader";
import { Check, ChevronsUpDown, Globe, Clock, Sparkles, Calendar, MapPin, Timer } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
const CustomCommand = ({ children, className }: { children: React.ReactNode; className?: string }) => (
  <div className={cn(
    "flex flex-col bg-white dark:from-gray-900 dark:to-gray-900/90", 
    "text-popover-foreground rounded-xl border border-gray-200/60 dark:border-gray-700/60 shadow-xl", 
    "backdrop-blur-sm",
    className
  )}>
