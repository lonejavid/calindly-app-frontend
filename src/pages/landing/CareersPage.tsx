      ...
      <section className="py-12 px-6 bg-gradient-to-r from-slate-800/50 to-purple-800/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {jobRoles.map((job) => (
              <div key={job.id} className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 transform">
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-slate-900 to-purple-900 rounded-2xl max-w-4xl max-h-[90vh] overflow-y-auto border border-white/20">
            <div className="p-6">
              ...
              <div className="mb-6">
                <h3 className="text-xl font-bold text-white mb-3">About the Job</h3>
